from orchestrator import openstackOriApiUtil
# orchestrator
...
class orchestrator:
    ...
    def new_vnf(self,vnf_info):
        # boot a vm
        nova_client = openstackOriApiUtil.get_nova_clint()
        vnf=openstackOriApiUtil.create_server(nova_client=nova_client, image_name=vnf_info.image_name, flavor_name=vnf_info.flavor_name,
